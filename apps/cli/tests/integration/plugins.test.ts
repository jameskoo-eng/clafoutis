...
describe('Plugin System', () => {
  ...
  it('loads and runs custom generator from path', async () => {
    ...
    const output = await fs.readFile(
      'build/my-custom/custom-output.txt',
      'utf-8'
    );
  ...
  it('receives StyleDictionary in context', async () => {
    ...
    const check = JSON.parse(
      await fs.readFile('build/sd-test/sd-check.json', 'utf-8')
    );
  ...
  it('receives config in context', async () => {
    ...
    const savedConfig = JSON.parse(
      await fs.readFile('build/config-test/config.json', 'utf-8')
    );
  ...
  it('receives tokensDir in context', async () => {
    ...
    const info = JSON.parse(
      await fs.readFile('build/tokens-test/tokens-info.json', 'utf-8')
    );
